...
async function BitcoinPage({ searchParams }) {
      ...
      <section className="news-wrap">
        <div className="_container">
          <div className="news-wrap__top">
            <h2>Bitcoin</h2>
            <p>
              Discover everything about Bitcoin: the latest news, price
              movements, mining updates, and market analysis. Stay informed with
              our comprehensive coverage of the world's leading cryptocurrency.
              Explore Bitcoin's evolution and its impact on the financial
              landscape.
            </p>
          </div>
