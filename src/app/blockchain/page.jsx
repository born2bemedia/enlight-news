      ...
      <section className="news-wrap">
        <div className="_container">
          <div className="news-wrap__top">
            <h2>Blockchain</h2>
            <p>
              Explore the latest blockchain innovations, news, and developments.
              Stay informed about emerging trends and breakthroughs in
              blockchain technology. Discover how blockchain is transforming
