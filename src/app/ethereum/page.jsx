...
export const metadata = {
  title: "Ethereum news | Enlight News",
  description:
    "Explore the latest Ethereum news, including price shifts, events and changes, and technology and blockchain innovations impacting the cryptocurrency.",
  openGraph: {
    title: "Ethereum news | Enlight News",
    description:
      "Explore the latest Ethereum news, including price shifts, events and changes, and technology and blockchain innovations impacting the cryptocurrency.",
...
async function EthereumPage({ searchParams }) {
      ...
      <section className="news-wrap">
        <div className="_container">
          <div className="news-wrap__top">
            <h2>Ethereum</h2>
            <p>
              Discover the latest news, updates, and developments in the
              Ethereum ecosystem. Stay informed about Ethereum's price, DeFi
              projects, and technological advancements. Explore the future of
              decentralised finance with Ethereum.
            </p>
          </div>
