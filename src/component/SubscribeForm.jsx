  ...
  try {
    ...
    if (response.ok) {
      ...
      setStatus({
        success: true,
        message:
          "Success! You have subscribed to our newsletter successfully! Please check your inbox for a greeting email from Enlight!",
      });
      setSubmitting(false);
    } else {
...
function SubscribeForm() {
  return (
    <div>
      ...
      >
        {({ setFieldValue, touched, errors, isSubmitting, status }) => (
          <>
